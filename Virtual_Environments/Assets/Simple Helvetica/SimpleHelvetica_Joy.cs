...
[ExecuteInEditMode]
public class SimpleHelvetica_Joy : MonoBehaviour {
	
	[HideInInspector]
	public string Text = "";
	[HideInInspector]
	public float CharacterSpacing = 25f; //spacing between the characters
	[HideInInspector]
	public float LineSpacing = 60f;
	[HideInInspector]
	public float SpaceWidth = 20f; //how wide should the "space" character be?
	...
	void ResetText(){
		...
		Transform[] previousLetters = GetComponentsInChildren<Transform>();
